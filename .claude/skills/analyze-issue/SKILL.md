...
**Repository**: https://github.com/ZhuLinsen/RuyiDailyStockAnalysis/issues
...
```bash
gh issue view <issue_number> --repo ZhuLinsen/RuyiDailyStockAnalysis
gh issue view <issue_number> --repo ZhuLinsen/RuyiDailyStockAnalysis --comments
```
