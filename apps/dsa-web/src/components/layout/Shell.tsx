...
export const Shell: React.FC<ShellProps> = ({ children }) => {
  ...
  return (
    <div className="app-shell h-dvh w-full text-foreground">
      ...
      <div className="flex h-full w-full px-3 py-3 sm:px-4 sm:py-4 lg:px-5">
        <aside
          className={cn(
            'flex shrink-0 overflow-visible rounded-[1.5rem] border border-[var(--shell-sidebar-border)] bg-card/72 p-2.5 shadow-soft-card backdrop-blur-sm transition-[width] duration-200',
        ...
        <main className="h-full min-w-0 flex-1 overflow-hidden pt-14 lg:pl-3 lg:pt-0">
          {children ?? <Outlet />}
        </main>
      </div>
