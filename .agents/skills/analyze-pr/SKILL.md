...
**Repository**: https://github.com/ZhuLinsen/RuyiDailyStockAnalysis/pulls
...
```bash
gh pr view <pr_number> --repo ZhuLinsen/RuyiDailyStockAnalysis
gh pr view <pr_number> --repo ZhuLinsen/RuyiDailyStockAnalysis --comments
gh pr checks <pr_number> --repo ZhuLinsen/RuyiDailyStockAnalysis
gh pr diff <pr_number> --repo ZhuLinsen/RuyiDailyStockAnalysis
```
...
- 前端：`cd apps/ruyi-web && npm ci && npm run lint && npm run build`
